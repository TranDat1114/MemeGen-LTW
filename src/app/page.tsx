...
import { TrendingUpIcon as Trending, Zap, Award, User } from "lucide-react"
...
export default function Home() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        <h2 className="flex items-center mb-4 font-semibold text-2xl">
          <Trending className="mr-2" /> Trending Memes
        </h2>
        <div className="gap-4 sm:gap-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3].map((i) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h3 className="mb-2 font-semibold">Trending Meme {i}</h3>
                <p className="text-muted-foreground">Created by: User{i}</p>
              </div>
            </Link>
          ))}
        </div>
